...
8. EXAMPLES
   ...
   EXAMPLE 1 -- 20-second puppy/rooster clip (approximately 35-45 words):
...
10. CTA max 12 words
10. All text in {language}
11. Do NOT invent events not visible in footage
12. Do NOT claim source footage is yours
...
print('Updated narration_prompt successfully with critical commentary rules')
