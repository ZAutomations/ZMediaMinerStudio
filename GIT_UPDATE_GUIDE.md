...
```
https://github.com/ZAutomations/ZMediaMiner-Studio.git
```
...
This creates a folder called `ZMediaMiner-Studio` with all the code.
...
3. Then clone normally: `git clone https://github.com/ZAutomations/ZMediaMiner-Studio.git`
